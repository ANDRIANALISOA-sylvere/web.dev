...
import Logo from "./bee-705412_640.webp";
        ...
        <div className="header">
            ...
            <header className="grid md:grid-cols-2 heading">
                <div className="text_heading mt-5 md:mt-14">
                    <h1 className="text-4xl md:text-7xl uppercase opacity-30 text-white">Web Solution</h1><br />
                    <span className="text-xl text-white">Explorer l'univers captivant de mes projets et <br />laissez-vous emporter par la passion.</span><br />
                    <button className="mt-5 text-white border-2 ms-2 border-white rounded-full md:h-12 px-4 py-2 hover:bg-white hover:text-black font-bold transition ease-out duration-500 hover:scale-125">Voir mes projets ...</button>
                </div>
